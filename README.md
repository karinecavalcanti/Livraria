Projeto de uma Livraria, tal projeto é um sistema com programação Orientada a Objetos em Java, com conexão a um banco de dados relacional SQL e uma interface gráfica.
